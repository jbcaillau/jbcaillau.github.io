...
\exo{ Soient $X$ et $Y$ deux espaces métriques complets. Soient $X_0$ un sous-ensemble dense de $X$ et $f:X_0\to f(X_0)\subset Y$ une isométrie.
\begin{enumerate}
    \item Montrer que l'application $f$ se prolonge en une unique fonction continue $\tilde f:X\to Y$.
    \item Montrer que si $f(X_0)$ est un sous-ensemble dense de $Y$, alors $\tilde f$ est une isométrie surjective de $X$ dans $Y$.
\end{enumerate}
}
